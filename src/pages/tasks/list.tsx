...
const List = () => {
  ...
  // Provides mutation function 
  const { mutate: updatedTask } = useUpdate();
  ...
  // Rendering for Page Skeleton
  if(isLoading) return <PageSkeleton />

  // Rendering for kanban board
  return (
    <>
      <KanbanBoardContainer>
